...
(function() {
  ...
  exports.parseFile = function(path, callback, { strict } = { strict: true }) {
    parse(PARSE_TYPE_FILE, path, callback, { strict });
  };

  exports.parseString = function(xmlString, callback, { strict = true } = { strict: true }) {
    parse(PARSE_TYPE_STRING, xmlString, callback, { strict });
  };

  exports.parseStdin = function(callback, { strict = true } = { strict: true }) {
    parse(PARSE_TYPE_STDIN, null, callback, { strict });
  };
  ...
  var parse = function(parseType, whatToParse, callback, { strict } = { strict: true }) {
